...
#install from dnf
sudo dnf install -y zsh firefox steam-devices neovim sqlite3 zsh-autosuggestions zsh-syntax-highlighting setroubleshoot newsboat ffmpeg compat-ffmpeg4 akmod-v4l2loopback yt-dlp guestfs-tools distrobox podman distrobox hugo simple-scan --best --allowerasing
